...
<div class="row">
    <div id="mrooms-footer" class="helplink col-sm-6">
        <small>
        <!-- Modificado footer Snap -->
        <?php
            echo "<hr/>";
            echo "<strong>© ".date('Y')." - Núcleo de Inovação em Tecnologias Aplicadas ao Ensino e Extensão (NITAE²)</strong>";
        ?>

        <!--footer Moodlerooms oculto -->
        <!--    <?php
